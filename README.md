...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/tbb-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/tbb-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add tbb tbb-devel tbb4py
# for installing globally
pixi global install tbb tbb-devel tbb4py
```
...
It is possible to list all of the versions of `tbb` available on your platform:
...
```
pixi search tbb --channel conda-forge
```
